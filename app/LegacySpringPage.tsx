...
export default function Home() {
  ...
  const runSearch = async () => {
    ...
    try {
      ...
      const requestBody = { query: query.trim(), limit: mobileView ? 2 : 4, term: "spring26" };
      ...
      await explainCourses(mobileView ? courses.slice(0, 2) : courses, query.trim(), setExplanations);
  ...
  return (
    <>
      ...
      >
        {leaderboardOpen ? (
          <LeaderboardPanel onClose={() => setLeaderboardOpen(false)} isMobile={isMobile} term="spring26" />
        ) : showSecretPage ? (
                ...
                <div style={{ flex: 1, overflow: "auto", width: "100%" }}>
                  <div style={styles.secretPageContent}>
                    ...
                    <form onSubmit={handleSaladEmailSubmit} style={styles.saladEmailForm}>
                      ...
                      />
                      <button type="submit" style={styles.saladEmailButton} aria-label="Submit">
